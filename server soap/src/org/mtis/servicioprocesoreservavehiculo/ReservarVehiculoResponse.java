 ...
 */
            ...
            /**
            *  ReservarVehiculoResponse bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ReservarVehiculoResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ReservarVehiculoResponse",
    ...
    public static class Factory{
        ...
        */
        public static ReservarVehiculoResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReservarVehiculoResponse object =
                new ReservarVehiculoResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ReservarVehiculoResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ReservarVehiculoResponse)org.mtis.servicioprocesoreservavehiculo.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mtis.org/ServicioProcesoReservaVehiculo/","exito").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mtis.org/ServicioProcesoReservaVehiculo/","mensaje").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mtis.org/ServicioProcesoReservaVehiculo/","idReserva").equals(reader.getName())){
