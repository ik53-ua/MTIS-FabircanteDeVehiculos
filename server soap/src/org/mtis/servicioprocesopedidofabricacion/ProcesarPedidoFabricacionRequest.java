...
/**
 * ProcesarPedidoFabricacionRequest.java
 *
 ...
 */
            ...
            /**
            *  ProcesarPedidoFabricacionRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ProcesarPedidoFabricacionRequest
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://mtis.org/ServicioProcesoPedidoFabricacion/",
                "ProcesarPedidoFabricacionRequest",
                "ns14");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ProcesarPedidoFabricacionRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ProcesarPedidoFabricacionRequest",
    ...
    public static class Factory{
        ...
        */
        public static ProcesarPedidoFabricacionRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ProcesarPedidoFabricacionRequest object =
                new ProcesarPedidoFabricacionRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ProcesarPedidoFabricacionRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ProcesarPedidoFabricacionRequest)org.mtis.servicioprocesopedidofabricacion.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mtis.org/ServicioProcesoPedidoFabricacion/","WSKey").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mtis.org/ServicioProcesoPedidoFabricacion/","idConcesionario").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mtis.org/ServicioProcesoPedidoFabricacion/","idModelo").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mtis.org/ServicioProcesoPedidoFabricacion/","configuracion").equals(reader.getName())){
