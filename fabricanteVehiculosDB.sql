...
CREATE TABLE ConfiguracionModelo (
...
-- Sede central (id=0) y concesionarios de la red
...
INSERT INTO InventarioVehiculo (vin, id_modelo, id_concesionario, estado, color, motor, fecha_fabricacion) VALUES
    ...
    ('VIN00000000000003', 1, 0, 'STOCK_FABRICANTE',     'Negro',   'Gasolina 1.8',     '2024-01-10'),
    ('VIN00000000000004', 2, 0, 'STOCK_FABRICANTE',     'Azul',    'Eléctrico 150kW',  '2024-02-20'),
    ('VIN00000000000005', 3, 2, 'STOCK_CONCESIONARIO',  'Gris',    'Diesel 3.0',       '2024-03-05'),
    ('VIN00000000000006', 1, 1, 'STOCK_CONCESIONARIO',  'Blanco',  'Diesel 2.0',       '2024-03-15'),
    ('VIN00000000000007', 2, 2, 'STOCK_CONCESIONARIO',  'Verde',   'Eléctrico 150kW',  '2024-04-01'),
    ('VIN00000000000008', 3, 0, 'STOCK_FABRICANTE',     'Negro',   'Gasolina 3.0',     '2024-04-10');
...
INSERT INTO StockRepuesto (id_concesionario, id_pieza, cantidad) VALUES
    (0, 1, 200),  -- Sede Central: 200 filtros de aceite
    (0, 2, 150),  -- Sede Central: 150 kits pastillas
    (0, 3, 80),   -- Sede Central: 80 baterías 12V
    (0, 4, 60),   -- Sede Central: 60 amortiguadores
    (0, 5, 40),   -- Sede Central: 40 correas distribución
    (0, 6, 30);   -- Sede Central: 30 kits embrague

-- Stock de repuestos en concesionarios
INSERT INTO StockRepuesto (id_concesionario, id_pieza, cantidad) VALUES
    (1, 1, 20),  -- Motor Levante: 20 filtros de aceite
    (1, 2, 8),   -- Motor Levante: 8 kits pastillas
    (1, 3, 0),   -- Motor Levante: sin stock de baterías
    (2, 1, 15),  -- Auto Sur: 15 filtros de aceite
    (2, 4, 6),   -- Auto Sur: 6 amortiguadores
    (2, 5, 0),   -- Auto Sur: sin stock de correas
    (3, 1, 10),  -- Coches del Este: 10 filtros
    (3, 2, 5);   -- Coches del Este: 5 kits pastillas
